                                                    ...
                                                    <form id="songEditform"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="song-point" type="number" min="0"
                                                                max="100" oninput="javascript: this.value = this.value.slice(0, 3);" class="form-control" name="points"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="artistform" action="{{ route('artist.search', ['song_list' => $song_detail['id']]) }}" method="post">
                            @csrf
                            <div class="mb-3">
                                <label for="artist-name" class="col-form-label">アーティスト名検索</label>
                                <input id="artist-input" type="text" class="form-control" name="artist_name"
                                    required>
